/**
 * OAuth test endpoint dla Furgonetka.pl
 * Umieszczony w /store/ routing
 */
...
/**
 * GET /store/furgonetka/test-oauth
 * Test OAuth połączenia z Furgonetka.pl (bez wymagania publishable key)
 */
